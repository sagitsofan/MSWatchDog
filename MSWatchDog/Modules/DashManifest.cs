...
namespace MSWatchDog.Modules.DashManifest
{
    // 
    // This source code was auto-generated by xsd, Version=4.6.1055.0.
    // 

    //curl "https://pluginprodma.streaming.mediaservices.windows.net/b39ff8a1-8a0f-4647-8e79-0174544d4fce/^%^D7^%^94^%^D7^%^95^%^D7^%^A4^%^D7^%^94^%^20-^%^20^%^D7^%^A2^%^D7^%^95^%^D7^%^9E^%^D7^%^A8^%^20^%^D7^%^90^%^D7^%^93^%^D7^%^9D^%^20-^%^2055651.ism/manifest(format=mpd-time-csf)" -H "User-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/58.0.3029.110 Safari/537.36" -H "Referer: https://kbox.pluginkaraoke.com/kboxhelpersWEB/azureplayer.aspx?songId=301260" -H "Origin: https://kbox.pluginkaraoke.com" --compressed
    //https://pluginprodma.streaming.mediaservices.windows.net/b39ff8a1-8a0f-4647-8e79-0174544d4fce/%D7%94%D7%95%D7%A4%D7%94%20-%20%D7%A2%D7%95%D7%9E%D7%A8%20%D7%90%D7%93%D7%9D%20-%2055651.ism/manifest(format=mpd-time-csf)
    //https://kbox.pluginkaraoke.com/kboxhelpersWEB/azureplayer.aspx?songId=301260
    ...
    public partial class RepresentationBaseType
    {
        ...
        private DescriptorType[] inbandEventStreamField;
        ...
        public DescriptorType[] InbandEventStream
        {
            get
            {
